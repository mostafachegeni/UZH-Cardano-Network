...
**IMPORTANT NOTE: Throughout the hands-on exercise, it is imperative that you maintain detailed records of the entire outputs generated in your terminal after executing the following scripts: `step5_register_stake_address.sh`, `step6_register_stake_pool.sh`, `step8_withdraw_rewards.sh`, `step9_deregister_pool.sh`, and `step10_deregister_stake_address.sh`. Subsequently, please forward these comprehensive output records to the Teaching Assistants (TAs) upon completion of the exercise as a pdf file.
