...
**IMPORTANT NOTE: Throughout the hands-on exercise, it is imperative that you maintain detailed records of the entire outputs generated in your terminal at each step. Subsequently, please forward these comprehensive output records to the Teaching Assistants (TAs) upon completion of the exercise as a pdf file.
